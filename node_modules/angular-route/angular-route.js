...
function $RouteProvider() {
   ...
   *    - `controllerAs` – `{string=}` – A com.controller alias name. If present the com.controller will be
   ...
   *      - `factory` - `{string|function}`: If `string` then it is an alias for a com.service.
   ...
   *
   * @description
   * Adds a new route definition to the `$route` com.service.
   */
  ...
  this.$get = ['$rootScope',
    ...
    var forceReload = false,
        ...
        $route = {
           ...
           *
           * @description
           * Causes `$route` com.service to reload the current route even if
           ...
           *
           * @description
           * Causes `$route` com.service to update the current URL, replacing
 ...
 *
 * @description
 * The `$routeParams` com.service allows you to retrieve the current set of route parameters.
 *
 * Requires the {@link ngRoute `ngRoute`} module to be installed.
 *
 ...
 *
 * The com.service guarantees that the identity of the `$routeParams` object will remain unchanged
